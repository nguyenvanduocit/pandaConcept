---
name: style-mediterranean-spanish
description: "Spanish Mediterranean Interior Design interior design style — detailed reference with colors (hex), materials, furniture, AI rendering keywords, and room applications"
---
...
1. Azulejo tiles — hand-painted blue-and-white ceramic tile panels (Portuguese and Spanish tradition)
2. Moorish arches and geometric lattice (*mashrabiya*) — Islamic architectural legacy
3. Courtyard (*patio*) with central fountain as the primary living space
4. Terracotta roof tiles (*tejas*) visible from interior through open loggias
5. Dark wrought iron grilles (*rejas*) on windows — decorative and protective
6. Patterned encaustic cement floor tiles (floral, geometric) — Andalusian specialty
7. Adobe or thick masonry walls — cool interior in extreme heat
8. Stucco walls in white, ochre, or dusty rose
9. Colorful Talavera pottery as decoration throughout
10. Esparto grass woven furniture and floor mats
11. Hammered copper sinks and decorative fountains
12. Heavy wooden doors with iron nail-head decoration
...
|---|---|---|
| Moorish Blue | `#2A5B8C` | Tile panels, accent |
| Saffron | `#E8A020` | Wall wash, textile |
| Adobe | `#C08050` | Walls, exterior plaster |
| Midnight Iron | `#2A2A2A` | Ironwork throughout |
| Dusty Rose | `#C8906A` | Stucco walls variant |
| Cobalt Tile | `#1A4A8C` | Azulejo patterns |
| Sand | `#D4B47A` | Stone surfaces, plaster |
| Terra Verde | `#5A7040` | Olive grove reference, plant |
...
Rustic, Bohemian, Desert/Southwestern, Maximalist

---

## Avoid
Scandinavian minimalism, cold grey palettes, synthetic materials, chrome fixtures, contemporary glass-heavy interiors
...
Eight centuries of Islamic civilization in Iberia left permanent architectural marks:
